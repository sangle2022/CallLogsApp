...
const env = {
  ...
  /** Call-log date range remains unchanged: default 7 calendar days. */
  maxSyncRangeDays: positiveInt('MAX_SYNC_RANGE_DAYS', 7),
  maxCallsPerSyncRequest: positiveInt('MAX_CALLS_PER_SYNC_REQUEST', 50),

  /** Recording uploads are intentionally restricted to one calendar day. */
  maxRecordingSyncRangeDays: positiveInt(
    'MAX_RECORDING_SYNC_RANGE_DAYS',
    1,
  ),
  ...
  maxAudioUploadBytes: positiveInt(
